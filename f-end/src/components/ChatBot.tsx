...
const ChatBot = () => {
  ...
  // Show quick prompts only when there's just the greeting + no assistant reply yet
      ...
      {open && (
        <div
          ...
          style={{
            ...
            width: 370, height: 520, zIndex: 9998,
        ...
        >
          ...
          {showScrollBtn && (
            <button
              ...
              style={{
                ...
                boxShadow: "0 2px 8px hsl(var(--primary)/0.4)", zIndex: 10,
              }}
            >
          ...
          {/* Quick prompts — always visible after AI replies too */}
          <div style={{
            padding: "6px 14px 8px",
            display: "flex", gap: 6, flexWrap: "wrap",
            flexShrink: 0,
            borderTop: showQuickPrompts ? "none" : "1px solid hsl(var(--border))",
          }}>
